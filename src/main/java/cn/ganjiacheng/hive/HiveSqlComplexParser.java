 ...
 */
public class HiveSqlComplexParser extends HiveSqlBaseVisitor {
    ...
    public HiveSqlComplexParser(String sql) {
        this.sourceSQL = sql;
    }
    ...
    public FieldLineageSelectItemModel getSelectItemModel(){
        return selectItemModel;
    }
    public List<FieldLineageSelectItemModel> getSelectFields(){
        return selectFields;
    }
